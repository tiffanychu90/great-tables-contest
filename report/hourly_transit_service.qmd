...
* Clearer examples by district: [Redwood Coast (District 1)](#district-01---eureka), [Roseville and Yolobus (District 3)](#district-03---marysville), [PresidiGo (District 4)](#district-04---oakland), [County Express (District 5)](#district-05---san-luis-obispo), [Delano (District 6)](#district-06---fresno), [Bell Gardens (District 7)](#district-07---los-angeles), [Beaumont Pass (District 8)](#district-08---san-bernardino), [Tracy (District 10)](#district-10---stockton), and [Imperial Valley Transit (District 11)](#district-11---san-diego).


### Steady 24 Hour Service
* [Bay Area 511 Muni (District 4)](#district-04---oakland) provides some level of service at all hours of the day. While it drops to roughly 10-15% capacity between 1 AM - 4 AM, it's impressive that there are still over 12,000 stops with scheduled service on the system. Service is simiar on the weekends as it is on weekdays.
* [Bay Area 511 BART (District 4)](#district-04---oakland) is similar to Muni. Two notable differences are that there is no BART service between 2 AM - 3 AM on weekdays (2 AM - 4 AM on weekends) and that weekend service begins one hour later in the morning.

### Commuter Service
* [Bay Area 511 Mission Bay and Bay Area 511 Commute.org (District 4)](#district-04---oakland) both serve commuter riders primarily, with pronounced AM and PM peak service, no scheduled midday arrivals during weekdays, and no weekend service.

### Primarily Midday Service
* [Cerritos on Wheels (District 7)](#district-07---los-angeles) operates strictly during business hours (9 AM - 5 PM).

### Traveler Service
* [LAX FlyAway (District 7)](#district-07---los-angeles) operates round-the-clock, dipping only between 2 AM - 3 AM.
* [Anaheim Resort (District 12)](#district-12---irvine) continuously provides shuttle service to Disneyland visitors, except from 2 AM - 4 AM.
...
Learn more about us or reach out: 
* [our analysis portfolio](analysis.calitp.org)
* [data-analyses GitHub](https://github.com/cal-itp/data-analyses/)
* [open source data-infrastructure](https://github.com/cal-itp/data-infra/)
* [email](mailto:hello@calitp.org)
